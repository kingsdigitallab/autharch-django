...
urlpatterns = [
    ...
    path('entities/new/corporate-body/', views.entity_create_corporate_body,
         name='entity-create-corporate-body'),
    path('entities/new/person/', views.entity_create_person,
         name='entity-create-person'),
