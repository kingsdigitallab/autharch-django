# Generated by Django 2.2.13 on 2020-07-22 00:44
...
def migrate_language_data(apps, schema_editor):
    ...
    for record in ArchivalRecord.objects.all():
        for language in record.languages.all():
            record.languages_new.add(lookup_language(
                ControlledVocabulary, ControlledTerm, language))
        record.language_new = lookup_language(ControlledVocabulary,
                                              ControlledTerm, record.language)
        record.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('archival', '0105_auto_20200722_0136'),
